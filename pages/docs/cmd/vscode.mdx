...
- `Ctrl + Shift + Alt + PgUp / PgDn` Seleção de coluna (caixa) page up/down

## Edição Rich languages

- `Ctrl + Space, Crtl I` Acionar sugestão
- `Ctrl + Shift + Space` Acionar dicas de parâmetro
...
<Callout type='info' emoji='ℹ️'>
  Compilado de todos os atalhos vscode feito por `usbalien.dev`
</Callout>
